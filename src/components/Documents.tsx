...
const CAT_COLORS: Record<string, string> = {
  rapport:"#6366f1", technique:"#f59e0b",
  humanitaire:"#10b981", formulaire:"#3b82f6", autre:"#9ca3af",
};
...
export function Documents() {
  ...
  return (
    <section id="documents" className="relative py-24 overflow-hidden bg-primary">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4 leading-tight">
            {t(
              <><span className="text-secondary">تقارير</span> ووثائق الجمعية</>,
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map(doc => {
              ...
              return (
                <div key={doc.id}
                  className="group flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-1">
