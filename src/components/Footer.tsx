        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              {t(
                'جمعية تنموية خيرية تعمل على دعم الفئات الهشة بإقليم تارودانت.',
                'Une association dédiée au soutien des plus démunis dans la province de Taroudant.'
              )}
            </p>
            <div className="flex items-center gap-3">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-muted rounded-full hover:bg-secondary hover:text-white transition-all">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-muted rounded-full hover:bg-secondary hover:text-white transition-all">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-muted rounded-full hover:bg-secondary hover:text-white transition-all">
                <Twitter className="w-4 h-4" />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-muted rounded-full hover:bg-secondary hover:text-white transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4 text-muted-foreground">
              ...
              <li>
                <Link href="/contact" className="font-semibold text-secondary hover:text-secondary/80 transition-colors">
